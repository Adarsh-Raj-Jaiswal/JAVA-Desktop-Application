...
public class Employee implements EmployeeInterface {
    ...
    // { -> these methods are declared in EmployeeInterface
    ...
    public boolean equals(Object other) {
        if (!(other instanceof EmployeeInterface)) // if it is not of type EmployeeInterface return false
            return false;
        EmployeeInterface employee = (EmployeeInterface) other;
        return this.employeeId.equalsIgnoreCase(employee.getEmployeeId()); // comparing using employeeId as primary key
    }

    // we have to overrite the compareTo functions because it is declared in
    // Comparable interface which is implemented by EmployeeInterface which we
    // are implementing
    public int compareTo(EmployeeInterface other) {
        return this.employeeId.compareToIgnoreCase(other.getEmployeeId());
    }

    // hascode method of obect class
    public int hashCode() {
